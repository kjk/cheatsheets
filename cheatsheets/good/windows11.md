...
Action | Shortcut 
------ | --------
Open up the **Widgets pane**.<br> It supplies you with the weather forecast, local traffic, news, and calendar | `Win + W`
Toggle up the **Quick Settings**.<br> It controls the Volume, Wi-Fi, Bluetooth, Brightness sliders, Focus Assist, and others | `Win + A`
Bring up the **Notification Center**.<br> It shows all your notifications in the OS | `Win + N`
Open the **Snap Layouts** flyout.<br> It helps you organize apps and windows for multitasking | `Win + Z`
Open **Teams Chat app** from Taskbar.<br> It helps you quickly select a chat thread directly from the Taskbar | `Win + C`
